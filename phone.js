import {readPetArchive} from './core.js';
...
try{
  ...
  if('serviceWorker'in navigator){await navigator.serviceWorker.register('./phone-sw.js');await navigator.serviceWorker.ready;}
